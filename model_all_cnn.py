...
def build_model(optimizer=HYPERPARAMS.optimizer, optimizer_param=HYPERPARAMS.optimizer_param,
    ...
    learning_rate_decay=HYPERPARAMS.learning_rate_decay, decay_step=HYPERPARAMS.decay_step, use_landmarks=False, use_hog_and_landmarks=False, use_hog_sliding_window_and_landmarks=False):

    if NETWORK.model == 'A':
        return build_modelA(optimizer, optimizer_param, learning_rate, keep_prob, learning_rate_decay, decay_step,use_landmarks, use_hog_and_landmarks,use_hog_sliding_window_and_landmarks)
    elif NETWORK.model == 'B':
        return build_modelB(optimizer, optimizer_param, learning_rate, keep_prob, learning_rate_decay, decay_step,use_landmarks, use_hog_and_landmarks,use_hog_sliding_window_and_landmarks)
    else:
...
def build_modelB(optimizer=HYPERPARAMS.optimizer, optimizer_param=HYPERPARAMS.optimizer_param,
    ...
    if use_landmarks or use_hog_and_landmarks:
