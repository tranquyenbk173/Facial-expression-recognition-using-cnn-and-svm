...
def predict(image, model, shape_predictor=None, use_landmarks=False,
...
if args.image:
    if os.path.isfile(args.image):
        ...
        emotion, confidence = predict(image, model, shape_predictor, use_landmarks=True, use_hog_and_landmarks=True, use_hog_sliding_window_and_landmarks=True)
